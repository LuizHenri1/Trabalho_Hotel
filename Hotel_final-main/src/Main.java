...
public class Main {
    ...
    private static void cadastrarHospede() throws HotelException {
        ...
        System.out.println("Digite a data de nascimento do hóspede (dd-mm-yyyy): ");
        ...
        try {
            ...
            throw new HotelException("Data de nascimento inválida. Use o formato dd-mm-yyyy");
        }
    }
    ...
    private static void realizarReserva() {
        try {
            ...
            System.out.println("Hóspede encontrado: " + hospede.getNome());
